...
user in an INI file next to HandBrakePortable.exe called HandBrakePortable.ini.
...
copy AppNamePortable.ini from this directory to HandBrakePortable.ini next to
HandBrakePortable.exe. The options in the INI file are as follows:
